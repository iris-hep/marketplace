...
- When using xAOD tool helpers, add `hep-llm-helpers>=0.1.0` to the active project; standalone PEP 723 scripts must list it in their dependency block, and imports use `hep_llm_helpers.xaod_hints`.
